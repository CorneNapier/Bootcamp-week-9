...
del countries[1]  # use del statement to delete by index position
...
listOfElements.remove("Zak")  # use remove method to delete by item value
print(listOfElements)
